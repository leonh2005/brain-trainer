...
- eating（頭部明顯靠近草架/食物區，且能看到嘴巴咀嚼、啃咬或頭部反覆上下點動；多張圖中頭部位置有微小變化代表正在進食）
- drinking（嘴巴靠近黃色水容器，有飲水動作）
- resting（靜止坐著或趴著，頭部沒有靠近草架，無咀嚼動作）
- stretching（身體完全伸展開來在伸懶腰）
- sleeping（身體側躺或蜷縮，眼睛閉著或幾乎不動，長時間靜止）
- other（其他動作）

eating vs resting 判斷關鍵（最容易混淆）：
- 頭部位置：靠近草架/食盆 → eating 可能性高；待在地墊中央 → resting
- 多張圖比較：頭部有輕微移動或位置變化 → eating；完全靜止 → resting
- 兔子耳朵豎立、眼睛張開且頭低向食物 → eating；耳朵放鬆、頭平放 → resting
